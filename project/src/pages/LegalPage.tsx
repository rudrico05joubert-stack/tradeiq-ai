...
const pages: Record<LegalPageName, { eyebrow: string; title: string; intro: string; sections: Section[] }> = {
  ...
  refunds: {
    ...
    sections: [
      ...
      { heading: '2. Cancelling', paragraphs: [`To stop the next renewal, email ${SUPPORT_EMAIL} from your account email before the next billing date. We will confirm cancellation. Your paid access normally continues until the end of the current billing period.`] },
